...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/50 bg-white/95 backdrop-blur-xl shadow-sm">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        ...
        <Link href="/" className="group flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-brand group-hover:text-gold transition">
            Hari Properties
          </span>
        </Link>
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium text-slate-600 md:flex">
          {navItems.map((item) => (
            <Link 
              key={item.href} 
              href={item.href} 
              className="transition hover:text-brand hover:font-semibold relative group"
            >
              {item.label}
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a 
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-700 hover:text-gold transition"
          ...
          <Link 
            href="/contact" 
            className="inline-flex items-center justify-center rounded-full bg-gold hover:bg-gold/90 px-6 py-2.5 text-sm font-semibold text-slate-950 transition-all hover:shadow-md" 
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-full border border-slate-200 hover:border-gold bg-white hover:bg-slate-50 p-3 text-slate-600 transition md:hidden"
        >
          {menuOpen ? (
